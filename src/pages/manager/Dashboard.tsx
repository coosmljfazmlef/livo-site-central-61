              ...
              <CardContent>
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-xl font-bold">{site.ticketCount}</div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">Members</div>
                    <div className="text-xl font-bold">{site.memberCount}</div>
                  </div>
                  <div>
                    <div className="text-sm text-muted-foreground">Urgent</div>
                    <div className="text-xl font-bold text-urgent">2</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <CardContent>
            <Tabs defaultValue="tickets">
              ...
              <TabsContent value="tickets" className="space-y-4">
                {[1, 2, 3].map((ticket) => (
                  <div key={ticket} className="flex items-center p-2 rounded-md hover:bg-muted/50">
              ...
              <TabsContent value="comments" className="space-y-4">
                {[1, 2, 3].map((comment) => (
                  <div key={comment} className="flex items-start p-2 rounded-md hover:bg-muted/50">
